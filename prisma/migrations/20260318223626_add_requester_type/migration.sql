...
CREATE TABLE "new_VoucherRequest" (
    ...
    "requesterType" TEXT NOT NULL DEFAULT 'RESPONSAVEL',
...
INSERT INTO "new_VoucherRequest" ("createdAt", "discountPercentage", "id", "installmentCount", "justification", "origin", "requestType", "requesterName", "responsible1Cpf", "responsible1Name", "responsible2Cpf", "responsible2Name", "schoolEmail", "schoolExternalId", "schoolId", "schoolName", "status", "ticketNumber", "updatedAt") SELECT "createdAt", "discountPercentage", "id", "installmentCount", "justification", "origin", "requestType", "requesterName", "responsible1Cpf", "responsible1Name", "responsible2Cpf", "responsible2Name", "schoolEmail", "schoolExternalId", "schoolId", "schoolName", "status", "ticketNumber", "updatedAt" FROM "VoucherRequest";
...
CREATE INDEX "VoucherRequest_requesterType_idx" ON "VoucherRequest"("requesterType");
